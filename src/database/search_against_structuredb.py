...
def search_against_structuredb(input_path : Path, output_path : Path, tmp_path : Path):
    """
    ...
    cmd = ["foldseek", "easy-search", str(input_path), STRUCTURE_DB, str(output_path), str(tmp_path), "--format-output", FOLDSEEK_OUT_FORMAT] #TODO add other arguments
